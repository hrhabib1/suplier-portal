...
const TopBar = ({handleLinkClick, clickedLink}) => {
  ...
  return (
    <div className="navbar bg-white p-1 fixed z-10 bg-opacity-100">
      ...
      <div className="flex-none gap-10 ">
        <Link
           className={`text-3xl text-black p-3 hover:bg-slate-100 ${
            clickedLink === "" ? "link-clicked" : "link-default"
        ...
        <Link
          className={`text-3xl text-black p-3 hover:bg-slate-100 ${
            clickedLink === "notification" ? "link-clicked" : "link-default"
          }`} onClick={() => handleLinkClick("notification")} to={"/notification"}
        >
          <IoIosNotificationsOutline />
        </Link>
        <Link
          className={`text-3xl text-black p-3 hover:bg-slate-100 ${
            clickedLink === "task" ? "link-clicked" : "link-default"
          }`}
        ...
        <Link
          className={`text-3xl text-black p-3 hover:bg-slate-100 ${
            clickedLink === "mail" ? "link-clicked" : "link-default"
          }`}
