const Sent = () => {
    const emails = [
        { from: 'Habibur', subject: 'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Minima similique incidunt ab qui itaque doloribus magni praesentium! Odit, corrupti maiores!', date: '5/06/2024' },
        { from: 'Hasan Gazi', subject: 'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Minima similique incidunt ab qui itaque doloribus magni praesentium! Odit, corrupti maiores!', date: '6/06/2024' },
    ...
    return (
        <div className="overflow-x-auto">
             <h1 className="text-black font-bold text-start text-2xl mb-10">Sent</h1>
